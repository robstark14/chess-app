...
class Move {
	...
	getWhitePossibleMoves () {
		...
		pieceID.onclick = (e) => {
			...
			if (this.type === 'queen') {
				...
				Object.assign(queen, new Bishop(e.currentTarget.id, this.rowPossible, this.colPossible));
	...
	getBlackPossibleMoves () {
		...
		pieceID.onclick = (e) => {
			...
			////////////// //white pawn
			if (this.type === 'pawn') {
				const blackPawn = new Pawn(e.currentTarget.id, 'black', this.rowPossible, this.colPossible);
				// if (this.turn === "black") {
